...
As medidas de centralidade buscam obter a relevância dos vértices, em função de algumas invariantes do grafo.
 ...
 Estudos revelaram que a centralidade de proximidade é influenciada pelo grau médio; a centralidade de intermediação pelo número de ligações e nós, a centralidade de 
\end{resumo}
...
Características relevantes de topologias sobreviventes são identificas em \cite{pavan} a partir de um conjunto de $29$ topologias físicas de redes reais, com número de nós de 9 à 100.
...
Em grafos como modelos para redes, as medidas de centralidade buscam medir a variação da relevância dos vértices, em função de algumas invariantes do grafo \cite{freitas}.
...
\begin{enumerate}
\item Busca pelo maior número de saltos do vértice quanto a todos ou outros, utilizando a matriz denominada {\it caminhoMinimo} previamene calculada.
...
12  &Usa        &100    &171    & 3.42  & 6  &0.06    &0.11     & 0.0022    &1720.56\\
\hline
\end{tabular}
\end{table}
...
A partir de um conjunto de redes reais foi obtido cinco medidas de centralidade: centralidade de intermediação, centralidade de proximidade, centralidade de intermediação, centralidade de proximidade e centralidade de grau.
Através destas medidas foram analizadas as variáveis de relevância para cada uma, onde para a centralidade de grau obteve como característica o ; na centralidade de intermediação as variáveis que influenciaram forma o número de ligações e o de nós; na centralidade de proximidade as variáveis foram e na centralidade de grau .
